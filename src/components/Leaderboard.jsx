...
export default function Leaderboard({ participants }) {
  ...
  // If CSV has badges, rank by badges; otherwise fall back to points.
  ...
  const filteredSorted = useMemo(() => {
    ...
    return rows;
  }, [participants, q, track, sortBy, sortDir]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0b1220] via-slate-950 to-black text-white">
      ...
      <div className="mx-auto max-w-6xl px-4 py-8">
        ...
        <header className="mb-6">
          ...
          <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:items-center">
            ...
            <div className="relative sm:w-1/2">
              <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" className="pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-white/50">
              ...
              <input
                ...
                placeholder="Search by name, org, or track..."
            ...
            {/* Sort By (only Name and Skill Badges) */}
            <select
              value={sortBy}
        ...
        {/* Podium (uses badges when available) */}
        ...
        {/* Leaderboard list (final column is Skill Badges) */}
        <section className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur shadow-[0_0_0_1px_rgba(255,255,255,0.06),0_8px_24px_rgba(0,0,0,0.35)] overflow-hidden">
          <div className="grid grid-cols-12 border-b border-white/10 px-4 py-3 text-xs uppercase tracking-wide text-white/60">
            ...
            <div className="col-span-5 sm:col-span-5">Participant</div>
            ...
            <div className="col-span-3 sm:col-span-1 text-right">Skill Badges</div>
          </div>
            ...
            {filteredSorted.map((p) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="col-span-5 flex items-center gap-3 sm:col-span-5">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-white/60 sm:hidden">{p.org}</div>
                    </div>
                  </div>

                  <div className="hidden col-span-3 text-sm text-white/80 sm:block">{p.org}</div>
        ...
        <div className="flex items-center gap-3 text-sm text-white/70">
              {/* <img
                src='https://www.svgrepo.com/show/156371/update-icon.svg'
                alt="Footer icon"
                className="h-6 w-6 rounded-md ring-1 ring-inset ring-white/15 object-cover"
              /> */}
